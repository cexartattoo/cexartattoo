...
with open("eslabon2_draft.py", "w", encoding="utf-8") as f:
    f.write(svg_content)

print("eslabon2_draft.py script has been rewritten successfully with the nuanced geometric adjustments")
